...
// This class is Menu card for MainActivityPagerAdapter
public class MenuCardFragment extends android.support.v4.app.Fragment implements View.OnClickListener {
    private final String TAG = "MenuCardFragment";
    ...
    public static MenuCardFragment newInstance(int id, String title, String description) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_menu_card, container, false);
